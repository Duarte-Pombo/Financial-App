              ...
              {cells.slice(wi * 7, wi * 7 + 7).map((day, ci) => {
                ...
                return (
                  ...
                  >
                    ...
                    {amount > 0 && (
                      <Text style={[styles.cellAmt, textDark && styles.cellAmtLight]}>€{Math.round(amount)}</Text>
                    )}
                  </Pressable>
                );
              })}
            ...
            <>
              <View style={styles.sheetHeader}>
                ...
                <View style={styles.sheetHeaderRight}>
                  <Text style={styles.sheetTotalAmount}>{fmtAmount(selectedData.totalAmount)}</Text>
